                    ...
                    <div class="full">
                        <div class="right_header_info">
                            <ul>
                                ...
                                <li class="button_user"><a class="button active" href="{$conf->action_url}register">Rejestracja</a></li>
                ...
                <div class="row">
                  <div class=" col-md-12">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <form class="main_form" action="{$conf->action_url}login" method="post">
                            <div class="row">
